        ...
        <div className="col-12 col-lg-8 res-margin">
				...
				<div className="col-12">
					...
					<figure>
						...
						<div className="image-slider">
							...
							<div>
								<img src="/images/blog/post-slide-2.jpg" className="img-responsive img-rounded" alt="Image" />
							</div>
							<div className="arrows">
								<a className="arrow left"><i className="fas fa-chevron-left"></i></a>
								<a className="arrow right"><i className="fas fa-chevron-right"></i></a>
							</div>
						</div>
			...
			<article className="row blog-post">
				<div className="col-12">
					...
					<figure>
						<img src="/images/blog/post-image.jpg" className="img-responsive img-rounded" alt="Image" />
					</figure>
