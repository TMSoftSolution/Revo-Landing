 ...
 * Copyright (c) 2016 Thomas Grainger; Licensed MIT */ !(function(a, b) {
  ...
  function h(a, b) {
    a.dispatchEvent != null ? a.dispatchEvent(b) : b in (a != null) ? a[b]() : `on${b}` in (a != null) && a[`on${b}`]();
  }
  function i(a, b, c) {
  ...
  const r = (function() {
    function a() {
      ...
      c(this, a),
        ...
        b.scrollContainer != null && (this.config.scrollContainer = document.querySelector(b.scrollContainer)),
    ...
    return (
      n(a, [
        ...
        },
        {
          key: 'doSync',
          value(a) {
            if (((typeof a !== 'undefined' && a !== null) || (a = this.element), a.nodeType === 1)) {
              a = a.parentNode || a;
        ...
        },
        {
          ...
          value(a) {
            ...
            const c = (this.config.scrollContainer && this.config.scrollContainer.scrollTop) || window.pageYOffset;
